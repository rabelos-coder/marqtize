...
export const APP_PAGINATION = parseInt(
  process.env.NEXT_PUBLIC_APP_PAGINATION ?? '10'
)
export const APP_PAGINATION_ROWS = (
...
// * SENTRY SETTINGS
export const SENTRY_EXAMPLE_PAGE_ENABLED =
  process.env.NEXT_PUBLIC_SENTRY_EXAMPLE_PAGE_ENABLED === 'true'
